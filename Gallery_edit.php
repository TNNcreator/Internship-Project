...
{
    $eid=$_REQUEST['edt'];
    $sql="select * from gallery where gallery_id ='$eid'";
...
if(isset($_REQUEST['insert']))
{
    ...
    $sql="update gallery set gallery_name='$user', gallery_img='$image' where gallery_id='$eid' ";
    mysqli_query($db,$sql);
...
<body>
   ...
   <div class="blog">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div><input type="text" placeholder="Gallery Name" required name="gallery_name" class="txt" value="<?php echo $res['gallery_name']; ?>"></div>

            <div>Gallery Image </div>
            <div><input type="file" name="gallery_img"  class="txt"> <img src="galleryimg/<?php echo $res['gallery_img'];?>" width=50 hight=40></div>
          ...
          <table border="1">
             ...
             {   
               ...
               <tr>
                   ...
                   <td><a href="galleryr.php?del=<?php echo $row['gallery_id'];?>" onclick="return confirm('you are sure !!!')">delete</a></td>
